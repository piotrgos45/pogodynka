...
class Measurement
{
    ...
    #[ORM\Column(type: Types::DECIMAL, precision: 5, scale: 7, nullable: true)]
    private ?string $windSpeed = null;

    #[ORM\Column(type: Types::DECIMAL, precision: 10, scale: 7, nullable: true)]
    private ?string $atmosphericPressure = null;
    ...
    public function setAtmosphericPressure(?string $atmosphericPressure): static
    {
